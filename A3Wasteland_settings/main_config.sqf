...
A3W_bleedingTime = 60*8;             // Time in seconds for which to allow revive after a critical injury (minimum 10 seconds)
...
// Server Naming
A3W_serverName = "TACX";			//Name of your server for Player HUD
A3W_serverIP = "74.91.119.57";		//IP address of your server for Player HUD
A3W_serverWWW = "TAC-X.com";		//Server HTTP address

// Spawning settings
A3W_serverSpawning = 1;            // Vehicle, object, and loot spawning (0 = no, 1 = yes)
A3W_vehicleSpawning = 1;           // If serverSpawning = 1, spawn vehicles in towns (0 = no, 1 = yes)
A3W_vehicleQuantity = 170;         // Approximate number of land vehicles to be spawned in towns
...
A3W_mainMissionDelay = 1*60;      // Time in seconds between Main Missions 10
A3W_mainMissionTimeout = 60*60;    // Time in seconds that a Main Mission will run for, unless completed 60
A3W_sideMissionDelay = 1*60;       // Time in seconds between Side Missions 5
A3W_sideMissionTimeout = 45*60;    // Time in seconds that a Side Mission will run for, unless completed 45
A3W_moneyMissionDelay = 1*60;     // Time in seconds between Money Missions 15
A3W_moneyMissionTimeout = 60*60;   // Time in seconds that a Money Mission will run for, unless completed 60
