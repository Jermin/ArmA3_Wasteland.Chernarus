...
[
	...
	["M1911a1", "rhsusf_weap_m1911a1", 50],
...
//	["Mk14 7.62 mm (Olive)", "srifle_DMR_06_olive_F", 1000],
	...
	["Shotgun M590A1 (Long)", "rhs_weap_M590_8RD", 400],
	["Shotgun M590A1 (short)", "rhs_weap_M590_5RD", 400],
	...
	["M4 (M203)", "rhs_weap_m4_m203", 375],
	["M4 (M203S)", "rhs_weap_m4_m203S", 375],
	["M4 (M320)", "rhs_m4_m320", 375],

	["M4A1 PIP", "rhs_weap_m4a1", 325],
	["M4A1 PIP (AFG)", "rhs_weap_m4a1_grip2", 325],
	["M4A1 PIP (Bipod)", "rhs_weap_m4a1_bipod", 325],
	["M4A1 PIP (Grippod)", "rhs_weap_m4a1_grip", 325],
	["M4A1 PIP (M203)", "rhs_weap_m4a1_m203", 375],
	["M4A1 PIP (M203S)", "rhs_weap_m4a1_m203S", 375],
	["M4A1 PIP (M320)", "rhs_m4a1_m320", 375],
	["M4A1 Carryhandle(M203)", "rhs_weap_m4a1_carryhandle_m203", 375],
	["M4A1 Carryhandle(M203S)", "rhs_weap_m4a1_carryhandle_m203S", 375],

	["M4A1 Block II", "rhs_weap_m4a1_blockII", 325],
	["M4A1 Block II (AFG)", "rhs_weap_m4a1_blockII_grip2", 325],
	["M4A1 Block II (AFG/KAC)", "rhs_weap_m4a1_blockII_grip2_KAC", 325],
	["M4A1 Block II (KAC)", "rhs_weap_m4a1_blockII_KAC", 325],
	["M4A1 Block II (M203)", "rhs_weap_m4a1_blockII_M203", 375],
	
	["MK 18 Mod 1", "rhs_weap_mk18", 325],
	["MK 18 Mod 1(AFG)", "rhs_weap_mk18_grip2", 325],
	["MK 18 Mod 1(AFG/KAC)", "rhs_weap_mk18_grip2_KAC", 325],
	["MK 18 Mod 1(KAC)", "rhs_weap_mk18_KAC", 325],
	["MK 18 Mod 1(M320)", "rhs_weap_mk18_m320", 375],

	["SR-25", "rhs_weap_sr25", 325],
	["SR-25 EC", "rhs_weap_sr25_ec", 325],
	...
	["ZID EAK-971", "hlc_rifle_aek971", 500],
...
// Sniper Rifles
	...
	["M14 (Rail)", "hlc_rifle_M14_Rail", 400],
	...
	["M320 LRR Sniper (Camo)", "srifle_LRR_camo_SOS_F", 1000],
	...
	["GM6 Lynx Sniper (Camo)", "srifle_GM6_camo_SOS_F", 1100]
...
[
	...
	["MK3A2 Concussion", "rhs_mag_mk3a2", 100],
	["M84 Stun Grenade", "rhs_mag_mk84", 100],
	["AN-M14 TH3 Incendenary", "rhs_mag_an_m14_th3", 100],
	["M7A3 Gas Grenade (FLASH BANG)", "rhs_mag_m7a3_cs", 100],
	["AN-M8HC White Smoke", "rhs_mag_an_m8hc", 100],
...
//DLC Ammo
	...
	["PKM", "rhs_mag_m67", 40],
	["M1911a1", "rhsusf_mag_7x45acp_MHP", 10],
	["762x51 m118 20rnd", "rhsusf_20Rnd_762x51_m118_special_Mag", 40],
	["762x51 B_M14 20 rnd", "hlc_20Rnd_762x51_B_M14", 40],
	["556x45 30Rnd", "rhs_mag_30Rnd_556x45_Mk318_Stanag", 40],
	["00 Buck 5Rnd", "rhsusf_5Rnd_00Buck", 40],
	["00 Buck 8Rnd", "rhsusf_8Rnd_00Buck", 40],
...
// DLC Items
	...
	//["TWS", "optic_tws", 500, "item"],
	//["TWS MG", "optic_tws_mg", 500, "item"],
...
[
	...
	["UAZ (crappy jeep)", "RHS_UAZ_MSV_01", 100, "vehicle"],
	["UAZ (crappy Jeep) open", "rhs_uaz_open_MSV_01", 100, "vehicle"],
	
	["Ural Blue (Flatbed Open)", "RHS_Ural_Open_Civ_01", 100, "vehicle"],
	["Ural (Flatbed Open)", "RHS_Ural_Open_MSV_01", 100, "vehicle"],	
	["Ural (Fuel)", "RHS_Ural_Fuel_MSV_01", 500, "vehicle"],	
			
	["GAZ-233011 Tigr", "rhs_tigr_msv", 500, "vehicle"],
	...
	["GAZ-66 (R-142N)", "rhs_gaz66_r142_msv", 500, "vehicle"],
	...
	["GAZ-66 (Health)", "rhs_gaz66_ap2_msv", 500, "vehicle"],
	...
	["GAZ-66 (Repair)", "rhs_gaz66_repair_msv", 500, "vehicle"],
				
				
	["M1025", "rhsusf_m1025_w", 500, "vehicle"],
		//["M1025 (Unarmed) Desert", "rhsusf_m1025_d", 4000, "vehicle"],
		//["M1025 (Unarmed/Snorkel)W", "rhsusf_m1025_w_s", 4000, "vehicle"],

	["M1078A1P2", "rhsusf_M1078A1P2_wd_fmtv_usarmy", 500, "vehicle"],
	["M1083A1P2 Camo", "rhsusf_M1083A1P2_wd_fmtv_usarmy", 500, "vehicle"],
	
	["RG33 MRAP", "rhsusf_rg33_d", 500, "vehicle"],
...
[
	...
	["M1078A1P2 Flatbed (M2)", "rhsusf_M1078A1P2_B_M2_wd_fmtv_usarmy", 1500, "vehicle"],
	["M1083A1P2 Flatbed (M2)", "rhsusf_M1083A1P2_B_M2_wd_fmtv_usarmy", 1500, "vehicle"],
	
	["M1025 (M2)", "rhsusf_m1025_w_m2", 5000, "vehicle"],
	...
	["M1025 (Mk19)", "rhsusf_m1025_w_mk19", 8000, "vehicle"],
	...
	["RG33 (M2) MRAP", "rhsusf_rg33_m2_wd", 10000, "vehicle"],
	

	["M113A3 (City APC)", "rhsusf_m113_usarmy", 10000, "vehicle"],
	...
	["BTR-70", "rhs_btr70_msv", 22500, "vehicle"],
		...
		//["BTR-70 APC chdkz", "rhs_btr70_chdkz", 22500, "vehicle"],
	
	["BTR-80", "rhs_btr80_msv", 24000, "vehicle"],
	...
	["BTR-80A", "rhs_btr80a_msv", 24000, "vehicle"],
	...
	["M2A2ODS (BUSK I)", "RHS_M2A2_BUSKI_wd", 36000, "vehicle"],
		//["M2A2ODS (BUSK I) Desert", "RHS_M2A2_BUSKI", 36000, "vehicle"],
	
	["M2A3", "RHS_M2A3", 36000, "vehicle"],
		//["M2A3 Desert", "RHS_M2A3", 36000, "vehicle"],

	["M2A3 (BUSK I)", "RHS_M2A3_BUSKI_wd", 36000, "vehicle"],
		//["M2A3 (BUSK I) Desert", "RHS_M2A3_BUSKI", 36000, "vehicle"],

	["M2A3 (BUSK III)", "RHS_M2A3_BUSKIII_wd", 36000, "vehicle"],
		//["M2A3 (BUSK III) Desert", "RHS_M2A3_BUSKIII", 36000, "vehicle"],

	["M6", "RHS_M6_wd", 30000, "vehicle"],
		//["M6", "RHS_M6", 30000, "vehicle"],

	["BMD-1k Command", "rhs_bmd1k", 30000, "vehicle"],
	["BMD-1R Rocket", "rhs_bmd1r", 30000, "vehicle"],
	["BMD-1 Combat", "rhs_bmd1", 30000, "vehicle"],
	["BMD-1p Combat", "rhs_bmd1p", 30000, "vehicle"],
	["BMD-1pk Command", "rhs_bmd1pk", 30000, "vehicle"],

	["BMD-2", "rhs_bmd2", 30000, "vehicle"],
	["BMD-2K Command", "rhs_bmd2k", 30000, "vehicle"],
	["BMD-2M Modern", "rhs_bmd2m", 30000, "vehicle"],

	["BMD-4", "rhs_bmd4_vdv", 30000, "vehicle"],
	["BMD-4M", "rhs_bmd4m_vdv", 30000, "vehicle"],
	["BMD-4M(A)", "rhs_bmd4ma_vdv", 30000, "vehicle"],

	["BMP-1", "rhs_bmp1_vdv", 30000, "vehicle"],
	["BMP-1D", "rhs_bmp1d_vdv", 30000, "vehicle"],
	["BMP-1k", "rhs_bmp1k_vdv", 30000, "vehicle"],
	["BMP-1P", "rhs_bmp1p_vdv", 30000, "vehicle"],
	["BMP-2", "rhs_bmp2_vdv", 30000, "vehicle"],
	["BMP-2 E", "rhs_bmp2e_vdv", 30000, "vehicle"],
	["BMP-2D", "rhs_bmp2d_vdv", 30000, "vehicle"],
	["BMP-2K", "rhs_bmp2k_vdv", 30000, "vehicle"],

	["BMP-3", "rhs_bmp3_late_msv", 30000, "vehicle"],

	["ZSU-23-4 (Anti Air)", "rhs_zsu234_aa", 35000, "vehicle"]
...
[
	...
	["9P129-1M (Single Rocket Launcher)", "rhs_9k79", 5000, "vehicle"],

	["2S25", "rhs_sprut_vdv", 40000, "vehicle"],
		
	["T-72Ba", "rhs_t72ba_tv", 50000, "vehicle"],
	["T-72Bb", "rhs_t72bb_tv", 50000, "vehicle"],
	["T-72Bc", "rhs_t72bc_tv", 50000, "vehicle"],
	["T-72B3", "rhs_t72bd_tv", 50000, "vehicle"],
	["T-80", "rhs_t80", 60000, "vehicle"],
	["T-80A", "rhs_t80a", 60000, "vehicle"],
	["T-80B", "rhs_t80b", 60000, "vehicle"],
	["T-80BK", "rhs_t80bk", 60000, "vehicle"],
	["T-80BV", "rhs_t80bv", 60000, "vehicle"],
	["T-80BVK", "rhs_t80bvk", 60000, "vehicle"],
	["T-80U", "rhs_t80u", 60000, "vehicle"],
	
	["M1A1FEP", "rhsusf_m1a1fep_wd", 70000, "vehicle"],
		//["M1A1FEP Desert", "rhsusf_m1a1fep_d", 70000, "vehicle"],
	["M1A1AIM", "rhsusf_m1a1aimwd_usarmy", 70000, "vehicle"],
		//["M1A1AIM Desert", "rhsusf_m1a1aimd_usarmy", 70000, "vehicle"],
	["M1A1AIM TUSK I", "rhsusf_m1a1aim_tuski_wd", 75000, "vehicle"],
		//["M1A1AIM TUSK I Desert", "rhsusf_m1a1aim_tuski_d", 75000, "vehicle"],
	["M1A2SEPv1", "rhsusf_m1a2sep1wd_usarmy", 75000, "vehicle"],
		//["M1A2SEPv1 Desert", "rhsusf_m1a2sep1d_usarmy", 75000, "vehicle"],
	["M1A2SEPv1 (Tusk I)", "rhsusf_m1a2sep1tuskiwd_usarmy", 80000, "vehicle"],
...
[
	...
	["CH-47 Chinook", "RHS_CH_47F", 9500, "vehicle"],
	...
	["UH1-Y Venom (USMC 2010) FFAR", "RHS_UH1Y_FFAR", 15000, "vehicle"],
	["UH1-Y Venom (USMC 2010)", "RHS_UH1Y", 20000, "vehicle"],
...
[
	["C-130J (Buggy passengers)", "RHS_C130J", 5000, "vehicle"],
